...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			if( get_theme_mod( 'feature_posts_section_layouts', 'feature_two' ) == '' || get_theme_mod( 'feature_posts_section_layouts', 'feature_two' ) == 'feature_one' ){
				get_template_part( 'template-parts/feature-posts/feature-posts', 'one' );
			}elseif( get_theme_mod( 'feature_posts_section_layouts', 'feature_two' ) == 'feature_two' ){
				get_template_part( 'template-parts/feature-posts/feature-posts', 'two' );
			} ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-insurance' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-insurance' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-insurance' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-insurance' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-insurance' ) . ' </span>',
									));
								endif;
							?>
						</div><!-- #primary -->
